...
public class Frame extends AbstractFrame<Frame> {
  ...
  public Frame add(GUIControl... controls) {
    group.add(controls);
    return this;
  }
  
  public Frame remove(GUIControl... controls) {
  ...
  public Frame setMenuBar(MenuBar menuBar) {
    frameAdapter.setMenuBar(menuBar.getComponent());
    menuBar.setWindow(this);
    return this;
  }
  
  public Frame setStatusBar(Control<?> statusBar) {
  ...
  public Frame addToolBar(ToolBar toolBar) {
  ...
  public Frame setCoolBar(CoolBar coolBar) {
    this.coolBar = coolBar;
    rootPanel.add(coolBar.getComponent(), BorderLayout.NORTH);
    return this;
  }
  
  public Frame setDefaultButton(AbstractButton<?> button) {
  ...
  private final BoundsModel<Frame> boundsModel = new BoundsModel<Frame>(this);
  
  @Override
  public BoundsModel<Frame> bounds() {
    return boundsModel;
  }
  
  public Frame centerOn(Window associatedWindow) {
  ...
  public Frame setStyleSheet(StyleSheet styleSheet) {
  ...
  @Override
  public Frame validate() {
    frameAdapter.validate();
    return this;
  }
  
  private final OwnedModel<Frame, String> title;
...
//  };
  ...
  public OwnedModel<Frame, String> title() {
    return title;
  }
  
  private final OwnedModel<Frame, Boolean> visible = new PluggableOwnedModel<Frame, Boolean>(this, new Accessor<Boolean>() {
    @Override
    public Boolean read() {
  ...
  @Override
  public OwnedModel<Frame, Boolean> visible() {
    return visible;
  }

  private final OwnedModel<Frame, Boolean> maximized = new PluggableOwnedModel<Frame, Boolean>(this, new Accessor<Boolean>() {
    @Override
    public Boolean read() {
  ...
  private static final class MyWindowAdapter extends WindowAdapter {
    private final WeakReference<Frame> windowReference;
    @SuppressWarnings("unused")
    private Frame windowHardReference;

    public MyWindowAdapter(Frame frame) {
      windowReference = new WeakReference<Frame>(frame);
    }
    ...
    public void windowClosed(WindowEvent e) {
      Frame frame = windowReference.get();
...
//      frame.removeWindowListener(windowAdapter);
    ...
    public void setMaximized(boolean maximized) {
      frame.setExtendedState(maximized ? java.awt.Frame.MAXIMIZED_BOTH : java.awt.Frame.NORMAL);
    }
  }
