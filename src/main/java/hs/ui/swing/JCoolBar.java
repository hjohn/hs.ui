...
//    setComponentOrientation(java.awt.ComponentOrientation.ComponentOrientation.RIGHT_TO_LEFT);
  ...
  protected JCoolBarItem[] getLineItems(int itemIndex) {
    ...
    Vector<JCoolBarItem> itemList = new Vector<JCoolBarItem>();
  ...
  @SuppressWarnings("null")  // This looks like it may actually be a bug or atleast badly structured code
  ...
  @SuppressWarnings("null")  // see mergeup
  ...
  protected void moveLeading(int itemIndex, int offX) {
    int offsetX = -offX;
    JCoolBarItem item = getItem(itemIndex);
    int xSpacing = item.getXSpacing();
  ...
  protected void moveTrailing(int itemIndex, int offX) {
    int offsetX = offX;
    JCoolBarItem item = getItem(itemIndex);
    int xSpacing = item.getXSpacing();
    int newXSpacing = xSpacing + offsetX;
